...
class lang_vi extends S {
  ...
  String get appName => "Love Music";
  String get appUpdateActionDownloadAgain => "Tải về";
  ...
  String get appUpdateDoubleBackTips => "Nhấn lại lần nữa, hủy tải xuống";
  String get appUpdateDownloadCanceled => "Hủy tải về";
  String get appUpdateDownloadFailed => "Lỗi tải về";
  String get appUpdateDownloading => "Đang tải...";
  String get appUpdateLeastVersion => "Phiên bản cũ";
  String get appUpdateReDownloadContent =>
      "Nó đã được phát hiện là nó đã được tải xuống, xem nó đã được cài đặt chưa?";
  String get appUpdateUpdate => "Cập nhật phiên bản";
  String get article_tag_top => "Top";
  String get autoBySystem => "Auto";
  String get clear => "Clear";
  String get close => "Close";
  String get coin => "Coin";
  String get collectionRemove => "Xóa bỏ";
  String get darkMode => "Chế độ tối";
  String get favourites => "Yêu thích";
  String get feedback => "FeedBack";
  String get fieldNotNull => "không rỗng";
  String get fontKuaiLe => "ZCOOL KuaiLe";
  String get githubIssue => "Không thể tìm thấy ứng dụng thư, vui lòng vấn đề github";
  String get loadFailed => "Tải không thành công, thử lại sau";
  String get logout => "Đăng xuất";
  String get myFavourites => "Sở thích của tôi";
  String get needLogin => "Đi tới Đăng nhập";
  String get noAccount => "Không có tài khoản ? ";
  String get openBrowser => "Mở Browser";
  ...
  String get twoPwdDifferent => "Hai mật khẩu khác nhau";
  String get unLike => "Không thích";
  String get userName => "Vui lòng nhập Tên người dùng";
  String get viewStateButtonLogin => "Đăng nhập";
  String get viewStateButtonRefresh => "Làm mới";
  String get viewStateButtonRetry => "Tải lại";
  String get viewStateMessageEmpty => "Không có kết quả";
  String get viewStateMessageError => "Lỗi tải";
  String get viewStateMessageNetworkError => "Tải không thành công, kiểm tra mạng ";
